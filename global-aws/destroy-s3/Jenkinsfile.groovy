/**
 * Jenkins script that uses Terraform to destroy AWS S3 global jarombek assets.
    ...
    agent {
        kubernetes {
            yaml """\
                ...
                kind: Pod
                metadata:
                  name: global-aws-destroy-s3
                  namespace: jenkins
                  labels:
                    version: v1.0.0
                    environment: development
                    application: global-aws-destroy-s3
                spec:
                  containers:
                    - name: terraform
...
def postScript() {
    def bodyTitle = "Destroy global-aws-infrastructure S3 global jarombek assets."
    def bodyContent = ""
