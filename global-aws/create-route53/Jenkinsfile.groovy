/**
 * Jenkins script that uses Terraform to create global AWS Route53 records and health checks.
...
def postScript() {
    def bodyTitle = "Create global-aws-infrastructure Route53 Resources."
    def bodyContent = ""
