/**
 * Jenkins script that uses Terraform to create an AWS S3 bucket for SaintsXCTF assets.
...
def terraformInit() {
    INFRA_DIR = "repos/saints-xctf-infrastructure/saints-xctf-com-asset"
...
def postScript() {
    def bodyTitle = "Create the saints-xctf-infrastructure asset S3 bucket."
    def bodyContent = ""
