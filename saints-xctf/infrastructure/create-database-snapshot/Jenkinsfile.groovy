/**
 * Jenkins script that uses Terraform to create backup and restore AWS Lambda functions for a SaintsXCTF MySQL database
 * on Amazon RDS.
...
def postScript() {
    def bodyTitle = "Create saints-xctf-infrastructure $params.environment Database Snapshot."
    def bodyContent = ""
