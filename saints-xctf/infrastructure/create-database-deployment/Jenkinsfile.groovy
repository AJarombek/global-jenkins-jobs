/**
 * Jenkins script that uses Terraform to create a database deployment AWS Lambda function for a SaintsXCTF MySQL
...
pipeline {
    ...
    parameters {
        ...
        choice(
            ...
            description: 'Environment to create the database deployment function.'
        )
    }
    options {
        ansiColor('xterm')
...
def postScript() {
    def bodyTitle = "Create saints-xctf-infrastructure $params.environment Database Deployment."
    def bodyContent = ""
