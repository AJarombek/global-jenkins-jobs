/**
 * Jenkins script that uses Terraform to destroy AWS and Kubernetes infrastructure used by the
...
pipeline {
    ...
    parameters {
        choice(
            ...
            description: 'Infrastructure module to destroy.'
        )
        booleanParam(
            name: 'autoDestroy',
            defaultValue: true,
...
def postScript() {
    def bodyTitle = "Destroy apollo-client-server-prototype $params.infrastructure Infrastructure."
    def bodyContent = ""
