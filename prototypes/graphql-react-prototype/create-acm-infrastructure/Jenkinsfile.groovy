/**
 * Jenkins script that uses Terraform to create ACM certificates used by the GraphQL React Prototype.
...
def postScript() {
    def bodyTitle = "Create graphql-react-prototype ACM Infrastructure."
    def bodyContent = ""
