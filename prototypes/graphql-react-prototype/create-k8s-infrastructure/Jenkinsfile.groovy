/**
 * Jenkins script that uses Terraform to create Kubernetes infrastructure for the GraphQL React Prototype.
...
def postScript() {
    def bodyTitle = "Create graphql-react-prototype Kubernetes Infrastructure."
    def bodyContent = ""
