/**
 * Jenkins script that uses Terraform to destroy ACM certificates used by the GraphQL React Prototype.
...
def terraformInit() {
    INFRA_DIR = "repos/graphql-react-prototype/infra/acm"
...
def postScript() {
    def bodyTitle = "Destroy graphql-react-prototype ACM Infrastructure."
    def bodyContent = ""
